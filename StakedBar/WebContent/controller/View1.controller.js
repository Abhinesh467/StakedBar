sap.ui.define([
	...
	return Controller.extend("com.numeric.StackedBar.controller.View1", {
		onInit: function () {
			// var sampleDatajson = new sap.ui.model.json.JSONModel("model/Data.json");
			var sampleDatajson = new sap.ui.model.json.JSONModel(jQuery.sap.getModulePath("com.numeric.StackedBar.model","/Data.json"));
